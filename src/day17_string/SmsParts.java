...
public class SmsParts {
    ...
    Sender: <James Bond>. From Number: [202-123-2456]. + Message: {"I love programming and problem solving"}

    Seperate  these parts and print them seprately
        Sender: actualSender
        Number: actualNumber
    ...
    public static void main(String[] args) {
        ...
        String msg = "Sender: <James Bond>. From Number: [202-123-2456]. + Message: {\"I love programming and problem" + " solving\"}";
