...
public class RemoveNums {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> nums = new ArrayList<>(Arrays.asList(1, 5, 2, 5, 2, 5, 1, 8, 9, 7, 4, 10, 2, 3));
        ...
        ArrayList<Integer> nums2 = new ArrayList<>(Arrays.asList(1, 5, 2, 5, 2, 5, 1, 8, 9, 7, 4, 10, 2, 3));
