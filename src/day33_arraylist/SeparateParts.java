...
Write a program that can extract the special characters, digits and letters from a string and stores them into separate ArrayLists of characters
    ...
    public static void main(String[] args) {
        ...
        letters.removeIf(p -> !Character.isLetter(p.charAt(0))); // p is every element, every element each character of the String, but those characters were String type, so in order to get a char type we did charAt(0). Characters methods needed char type
