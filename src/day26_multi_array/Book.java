...
public class Book {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < chapters; i++) {
            ...
            book[i] = input.nextLine().split(" "); // reading a String from the console then triming the extra spaces in the beginning and end and finally splitting the array by the spaces, getting a String array with each word as a separate element. That String array is stored into the book 2D array
