...
public class MoveZeros {
 ...
 Write a program  that will move all the zero number to the end of the array. The rest of the number will move over in position
 ...
 Hint: You don't have to manipulate the given array, try to use another array too. Think about the indexes
    ...
    public static void main(String[] args) {
        ...
        int[] fixed = new int[nums.length]; // [10, 0, 0, 0, 0, 0]
