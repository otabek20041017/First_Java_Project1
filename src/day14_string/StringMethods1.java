...
public class StringMethods1 {
    public static void main(String[] args) {
        ...
        System.out.println(str.trim()); // prints how many characters the String has, not the String
        // print(7)

        System.out.println("-------------------------------");
        String word = "Summer";
        word.toUpperCase(); // the uppercase method makes all the character uppercase, but we didn't with this value
        // nextInt();
        ...
        */
        ...
        s = s.trim(); // trim() metohd get rid of all the extra spaces in the beginning and end of a String
