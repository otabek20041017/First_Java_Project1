...
public class SignUp {
    ...
    public static void main(String[] args) {
        ...
        String confirm =  fullName + " you signed up! with email: " + email + ". We are glad to get readers ate age: " + age + ". You signed up for extra newsletter: " + extra + ". Credit goes to " + hearAboutUs;
