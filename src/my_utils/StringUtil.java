...
public class StringUtil {
    ...
    create a method will accept a String and
     return a String in proper format. Proper
     format is:
...
Exception: First word starts with lowercase
    ...
    /* Given a String and char determine
    how many times the given char is found in the String
       "java"
        a
