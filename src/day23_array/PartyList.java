...
public class PartyList {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < names.length; i++) { // purpose: ask for the name, and store to the array
            System.out.println("Enter a number of person " + (i));// if you don't have parenthesis the line will concatenate left to right, but we want to do addition first i + 1, then concatenate the message
