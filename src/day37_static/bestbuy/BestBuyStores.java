...
public class BestBuyStores {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(store1.headquarters); /* instances(object) come from a class & static members belong to class.
        this is valid syntax, but you should use the class name to access, but instance
         references */
