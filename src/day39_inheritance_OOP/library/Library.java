package day39_inheritance_OOP.library;
...
public class Library {
    public static void main(String[] args) {
        ...
        book1.title = "Atomic";
        // book1 has access to 6 variables: author, hasMovie, title, genre, chapters, numberOfPagers
        ...
        //book33 has access to 8 variables. All the variables from the parent Book class and the two variables declared in the Ebook class
