package day39_inheritance_OOP.access.b;
...
public class RunnerB {
    public static void main(String[] args) {
        ...
        //house.city = "Virgina"; no accessible outside the package
        //house.state; state is default, so only accessible in the sames package
